...
scalar product of conductances and fine root proportions and $K^{-1}$ is the inverse of the whole-plant conductance function (see function \texttt{hydraulics.K2Psi()}). 

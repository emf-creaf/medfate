...
\item{Increase soil moisture due to rainfall ($Pr$), runon ($Ro$) and (if considered) snow melting ($Sm$), after accounting for canopy interception loss ($In$), surface runoff ($Ru$) and deep drainage ($Dd$);}
...
Following Granier (1999), part of the water reaching one soil layer percolates quickly

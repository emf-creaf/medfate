...
\begin{equation}
RWC(\Psi_{leaf}) = RWC_{apo}(\Psi_{leaf}) \cdot a_{f,l} + RWC_{sym}(\Psi_{leaf}) \cdot (1 - f_{apo,l})
\end{equation}
...
\subsubsection{Xylem apoplastic volume and PLC}

We assume that the percentage of conductance loss (PLC) is related to the volume in xylem apoplastic tissue with respect to the maximum volume (Martin-StPaul et al. 2017), i.e.:
\begin{equation}
PLC_{xylem} = 1 - RWC_{apo}(\Psi_{stem})
\end{equation}
With this assumption one can relate decreases in water content in xylem conduits with changes in PLC. More importantly, one can invert RWC to find the stem water potential corresponding to the current degree of stem cavitation, to be used in integrals of the vulnerability curve.
...
par(mar=c(4,4,2,1), mfrow=c(1,2))
psiMax = -7.0
supplyNetwork11 = hydraulics.supplyFunctionRootSystem(psiSoilLayers1,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork12 = hydraulics.supplyFunctionRootSystem(psiSoilLayers2,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork13 = hydraulics.supplyFunctionRootSystem(psiSoilLayers3,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork14 = hydraulics.supplyFunctionRootSystem(psiSoilLayers4,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork21 = hydraulics.supplyFunctionRootSystem(psiSoilLayers1,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork22 = hydraulics.supplyFunctionRootSystem(psiSoilLayers2,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork23 = hydraulics.supplyFunctionRootSystem(psiSoilLayers3,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork24 = hydraulics.supplyFunctionRootSystem(psiSoilLayers4,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork31 = hydraulics.supplyFunctionRootSystem(psiSoilLayers1,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork32 = hydraulics.supplyFunctionRootSystem(psiSoilLayers2,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork33 = hydraulics.supplyFunctionRootSystem(psiSoilLayers3,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyNetwork34 = hydraulics.supplyFunctionRootSystem(psiSoilLayers4,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
plot(-supplyNetwork11$PsiRoot, supplyNetwork11$E, type="l", col=col1, ylab="Flow rate  (mmol·m-2·s-1)", 
     xlab = "Root crown pressure (-MPa)",  xlim=c(0, 7), ylim=c(0,max(supplyNetwork11$E)), lwd=1, main  = "E")
lines(-supplyNetwork12$PsiRoot, supplyNetwork12$E, lty=1, col=col2)
lines(-supplyNetwork13$PsiRoot, supplyNetwork13$E, lty=1, col=col3)
lines(-supplyNetwork14$PsiRoot, supplyNetwork14$E, lty=1, col=col4)
lines(-supplyNetwork21$PsiRoot, supplyNetwork21$E, lty=2, col=col1)
lines(-supplyNetwork22$PsiRoot, supplyNetwork22$E, lty=2, col=col2)
lines(-supplyNetwork23$PsiRoot, supplyNetwork23$E, lty=2, col=col3)
lines(-supplyNetwork24$PsiRoot, supplyNetwork24$E, lty=2, col=col4)
lines(-supplyNetwork32$PsiRoot, supplyNetwork32$E, lty=3, col=col1)
lines(-supplyNetwork32$PsiRoot, supplyNetwork32$E, lty=3, col=col2)
lines(-supplyNetwork33$PsiRoot, supplyNetwork33$E, lty=3, col=col3)
lines(-supplyNetwork34$PsiRoot, supplyNetwork34$E, lty=3, col=col4)
legend("topleft", bty="n", legend=textures, lwd=1, lty=1:3, cex=0.8)

plot(-supplyNetwork11$PsiRoot, supplyNetwork11$dEdP, type="l", col=col1, ylab="dE/dP  (mmol·m-2·s-1·MPa-1)", 
     xlab = "Root crown pressure (-MPa)",  xlim=c(0, 7), ylim=c(0,max(supplyNetwork11$dEdP)), lwd=1, main="dE/dP")
lines(-supplyNetwork12$PsiRoot, supplyNetwork12$dEdP, lty=1, col=col2)
lines(-supplyNetwork13$PsiRoot, supplyNetwork13$dEdP, lty=1, col=col3)
lines(-supplyNetwork14$PsiRoot, supplyNetwork14$dEdP, lty=1, col=col4)
lines(-supplyNetwork21$PsiRoot, supplyNetwork21$dEdP, lty=2, col=col1)
lines(-supplyNetwork22$PsiRoot, supplyNetwork22$dEdP, lty=2, col=col2)
lines(-supplyNetwork23$PsiRoot, supplyNetwork23$dEdP, lty=2, col=col3)
lines(-supplyNetwork24$PsiRoot, supplyNetwork24$dEdP, lty=2, col=col4)
lines(-supplyNetwork31$PsiRoot, supplyNetwork31$dEdP, lty=3, col=col1)
lines(-supplyNetwork32$PsiRoot, supplyNetwork32$dEdP, lty=3, col=col2)
lines(-supplyNetwork33$PsiRoot, supplyNetwork33$dEdP, lty=3, col=col3)
lines(-supplyNetwork34$PsiRoot, supplyNetwork34$dEdP, lty=3, col=col4)
legend("topright", bty="n", legend=textures, lwd=1, lty=1:3, cex=0.8)
@
\end{center}
...
plot(supplyNetwork21$E, -supplyNetwork21$PsiRoot, type="l", col="black", xlab="Total flow rate", 
...
plot(supplyNetwork22$E, -supplyNetwork22$PsiRoot, type="l", col="black", xlab="Total flow rate", 
     ylab = "Pressure (-MPa)",  main="Soil potentials 2 (original)", ylim=c(0, 5), xlim=c(0,max(supplyNetwork22$E)), lwd=2)
lines(supplyNetwork22$E,-supplyNetwork22$PsiRhizo[,1], lty=4, col="black", lwd=2)
lines(supplyNetwork22$E,-supplyNetwork22$PsiRhizo[,2],  lty=4, col="red", lwd=2)
lines(supplyNetwork22$E,-supplyNetwork22$PsiRhizo[,3], lty=4, col="blue", lwd=2)
legend("topleft", bty="n", legend=c("Root crown", "Rhizo 1", "Rhizo 2", "Rhizo 3"), 
       lwd=2, lty=c(1,2,3,4,4,4), col=c(rep("black",4), "red","blue"), cex=0.8)

plot(supplyNetwork23$E, -supplyNetwork23$PsiRoot, type="l", col="black", xlab="Total flow rate", 
     ylab = "Pressure (-MPa)",  main="Soil potentials 3 (original)", ylim=c(0, 5), xlim=c(0,max(supplyNetwork23$E)), lwd=2)
lines(supplyNetwork23$E,-supplyNetwork23$PsiRhizo[,1], lty=4, col="black", lwd=2)
lines(supplyNetwork23$E,-supplyNetwork23$PsiRhizo[,2],  lty=4, col="red", lwd=2)
lines(supplyNetwork23$E,-supplyNetwork23$PsiRhizo[,3], lty=4, col="blue", lwd=2)
legend("topleft", bty="n", legend=c("Root crown", "Rhizo 1", "Rhizo 2", "Rhizo 3"), 
       lwd=2, lty=c(1,2,3,4,4,4), col=c(rep("black",4), "red","blue"), cex=0.8)
plot(supplyNetwork24$E, -supplyNetwork24$PsiRoot, type="l", col="black", xlab="Total flow rate", 
...
plot(supplyNetwork21$E, supplyNetwork21$Elayers[,1], type="l", col="black", xlab="Total flow rate", 
     ylab = "Path flow rate",  main="Soil potentials 1",  xlim=c(0, 4), ylim=c(-1,4), lwd=1)
lines(supplyNetwork21$E, supplyNetwork21$Elayers[,2], lty=2)
lines(supplyNetwork21$E, supplyNetwork21$Elayers[,3], lty=3)
abline(h=0, col="gray")
legend("topleft", legend=c("Layer 1", "Layer 2", "Layer 3"), bty="n", lty=c(1,2,3))
plot(supplyNetwork22$E, supplyNetwork22$Elayers[,1], type="l", col="black", xlab="Total flow rate", 
     ylab = "Path flow rate",  main="Soil potentials 2",  xlim=c(0, 2), ylim=c(-0.5,2), lwd=1)
lines(supplyNetwork22$E, supplyNetwork22$Elayers[,2], lty=2)
lines(supplyNetwork22$E, supplyNetwork22$Elayers[,3], lty=3)
abline(h=0, col="gray")
legend("topleft", legend=c("Layer 1", "Layer 2", "Layer 3"), bty="n", lty=c(1,2,3))
plot(supplyNetwork23$E, supplyNetwork23$Elayers[,1], type="l", col="black", xlab="Total flow rate", 
     ylab = "Path flow rate",  main="Soil potentials 3",  xlim=c(0, 0.4), ylim=c(-0.2,0.4), lwd=1)
lines(supplyNetwork23$E, supplyNetwork23$Elayers[,2], lty=2)
lines(supplyNetwork23$E, supplyNetwork23$Elayers[,3], lty=3)
abline(h=0, col="gray")
legend("topleft", legend=c("Layer 1", "Layer 2", "Layer 3"), bty="n", lty=c(1,2,3))
plot(supplyNetwork24$E, supplyNetwork24$Elayers[,1], type="l", col="black", xlab="Total flow rate", 
     ylab = "Path flow rate",  main="Soil potentials 4",  xlim=c(0, 0.05), ylim=c(-0.05,0.05), lwd=1)
lines(supplyNetwork24$E, supplyNetwork24$Elayers[,2], lty=2)
lines(supplyNetwork24$E, supplyNetwork24$Elayers[,3], lty=3)
abline(h=0, col="gray")
legend("topleft", legend=c("Layer 1", "Layer 2", "Layer 3"), bty="n", lty=c(1,2,3))
@
\end{center}
...
\subsubsection{Effects on the supply function}
So far we have been concerned with the steady-state flow of a hydraulic network assuming there are no other sources of water than that of the soil. Water potential at the upper end of the stem ($\Psi_{stem}$) was obtained integrating the stem xylem vulnerability curve, using $\Psi_{up,k}=\Psi_{rootcrown}$ and making the result equal to the input flow from the root system. Now we will consider the effect of additional sources of water from stem tissues on the water supply function. From one time step to the next, the steady-state flow will dictate different values of $\Psi_{stem}$. This translates into changes in apoplastic water content in the sapwood and this source of water should be added to the transpirational stream. Additionally, the symplastic storage compartment contribute to sapflow dynamics by continuously exchanging water with xylem. If we consider the two sources, the downstream instantaneous flow may not necessarily be equal to the flow entering the stem:
\begin{equation}
...
\subsubsection{Storage compartment and cavitation}
The consideration of a symplastic storage compartment opens the door to simulating xylem refilling explicitly, while at the same time allowing a histeretic curve of recovery after drought. When cavitation is considered, one has to store $\Psi_{cav}$ the stem water potential corresponding to the current percentage of stem conductance loss due to cavitation. After cavitation we have that stem conductance cannot be higher than: 
\begin{equation}
k_{cav} = k_{stem}(\Psi_{cav}) = k_{stem,max}\cdot e^{-((\Psi_{cav}/d)^c)}
\end{equation}
If refilling does not occur, $k_{cav}$ can only decrease or stay constant, but never increase. When soil is replenished, we may allow progressive refilling by assuming that water entering the xylem from the storage compartment helps filling embolized conduits. To do so, we assume that the flow entering the xylem is 
\begin{equation}
k_{refill} = (\Psi_{storage} - \Psi_h)\cdot 2 \pi \cdot D_{int} \cdot L
\end{equation}
Then we invert the vulnerability curve to find the new value of $\Psi_{cav}$:
\begin{equation}
\Psi_{cav} = k_{stem}^{-1}(k_{cav}+k_{refill})}
\end{equation}
Note that, as before, $k_{refill}$ needs to be expressed in conductance units, i.e. mmol·m$^{-2}$·MPa$^{-1}·s$^{-1}$.
...
\subsubsection{Storage compartments}
...
\begin{center}
    ...
    \hline
    Symbol & Unit & Param. & Description \\ \hline

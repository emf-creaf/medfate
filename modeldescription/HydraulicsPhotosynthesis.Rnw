...
\item{Calculate the water volume within the segment, corresponding to the steady-state upstream and downstream water potential values: 
\begin{equation}
V_{i} = V_{sapwood,i} \cdot f_{apo, s} \cdot \frac{RWC_{apo,s}(\Psi_{up,i})+ RWC_{apo,s}(\Psi_{down,i})}{2}
\end{equation}
where $V_{sapwood,i}$ is the maximum water volume in segment $i$, i.e. the fraction of $V_{sapwood}$ depending on the number of segments.
...
After all stem segments are processed, one can continue with the pressure drop due to the leaf resistance. We first define five segments and three values of $V_{sapwood}$.
<<>>=
nseg = 5
PLC1 = rep(0, nseg)
PLC2 = c(0.0, 0.05, 0.1, 0.15,0.2)
PLC3 = c(0.25, 0.3,0.35,0.4, 0.45)
fapo = 0.8
Vmax1 = 0.000125 # 2 m height
Vmax2 = 0.000625
Vmax3 = 0.00125 # 20 m height
tstep = 3600
@

The following example shows the supply function, i.e. flow against downstream leaf pressure, for the unsegmented case (continuous line) and for a stem with the five segments and the three different values of $V_{sapwood}$ (function \texttt{supplyFunctionAboveground}, dashed and dotted lines):
\begin{center}
<<fig=TRUE, width=5, height=4.5, echo=FALSE>>==
RWCstorage = rep(1,5)
epsilon = 12
pi0 = -3
klat = 0.0
...
supplyAG11 = hydraulics.supplyFunctionAboveGround(supplyRS11$E, supplyRS11$PsiRoot,
                                                  ...
                                                  klat, ksto, tstep, psiStep = -0.0001)
...
supplyAG13 = hydraulics.supplyFunctionAboveGround(supplyRS11$E, supplyRS11$PsiRoot,
                                                  ...
                                                  klat, ksto, tstep, psiStep = -0.0001)
supplyAG21 = hydraulics.supplyFunctionAboveGround(supplyRS12$E, supplyRS12$PsiRoot,
                                                  PLC2, RWCstorage,
                                                  kstemmax, stemc, stemd,
                                                  kleafmax, leafc, leafd,
                                                  Vmax1, fapo, pi0, epsilon,
                                                  klat, ksto, tstep, psiStep = -0.0001)
supplyAG22 = hydraulics.supplyFunctionAboveGround(supplyRS12$E, supplyRS12$PsiRoot,
                                                  PLC2, RWCstorage,
                                                  kstemmax, stemc, stemd,
                                                  kleafmax, leafc, leafd,
                                                  Vmax2, fapo, pi0, epsilon,
                                                  klat, ksto, tstep, psiStep = -0.0001)
supplyAG23 = hydraulics.supplyFunctionAboveGround(supplyRS12$E, supplyRS12$PsiRoot,
                                                  PLC2, RWCstorage,
                                                  kstemmax, stemc, stemd,
                                                  kleafmax, leafc, leafd,
                                                  Vmax3, fapo, pi0, epsilon,
                                                  klat, ksto, tstep, psiStep = -0.0001)
supplyAG31 = hydraulics.supplyFunctionAboveGround(supplyRS13$E, supplyRS13$PsiRoot,
                                                  PLC3, RWCstorage,
                                                  kstemmax, stemc, stemd,
                                                  kleafmax, leafc, leafd,
                                                  Vmax1, fapo, pi0, epsilon,
                                                  klat, ksto, tstep, psiStep = -0.0001)
supplyAG32 = hydraulics.supplyFunctionAboveGround(supplyRS13$E, supplyRS13$PsiRoot,
                                                  PLC3, RWCstorage,
                                                  kstemmax, stemc, stemd,
                                                  kleafmax, leafc, leafd,
                                                  Vmax2, fapo, pi0, epsilon,
                                                  klat, ksto, tstep, psiStep = -0.0001)
supplyAG33 = hydraulics.supplyFunctionAboveGround(supplyRS13$E, supplyRS13$PsiRoot,
                                                  PLC3, RWCstorage,
                                                  kstemmax, stemc, stemd,
                                                  kleafmax, leafc, leafd,
                                                  Vmax3, fapo, pi0, epsilon,
                                                  klat, ksto, tstep, psiStep = -0.0001)
plot(-supplyNetwork11$PsiLeaf, supplyNetwork11$E, type="l", col=col1, ylab="Flow rate  (mmol·m-2·s-1)", 
     xlab = "Leaf pressure (-MPa)",  xlim=c(0, 7), ylim=c(0,5), lwd=1)
...
lines(-supplyNetwork12$PsiLeaf, supplyNetwork12$E, lty=1, col=col2)
lines(-supplyAG21$PsiLeaf, supplyAG21$E, lty=2, col=col2)
lines(-supplyAG22$PsiLeaf, supplyAG22$E, lty=3, col=col2)
lines(-supplyAG23$PsiLeaf, supplyAG23$E, lty=4, col=col2)
lines(-supplyNetwork13$PsiLeaf, supplyNetwork13$E, lty=1, col=col3)
lines(-supplyAG31$PsiLeaf, supplyAG31$E, lty=2, col=col3)
lines(-supplyAG32$PsiLeaf, supplyAG32$E, lty=3, col=col3)
lines(-supplyAG33$PsiLeaf, supplyAG33$E, lty=4, col=col3)
@
\end{center}

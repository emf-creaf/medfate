...
Having all these maximum conductances, we can now build the supply functions for each soil texture and starting from the different soil water potential configurations (see function \texttt{hydraulics.supplyFunctionBelowground()}): 
\begin{center}
<<fig=TRUE, width=8, height=4.5, echo=FALSE>>==
par(mar=c(4,4,2,1), mfrow=c(1,2))
psiMax = -7.0
supplyRS11 = hydraulics.supplyFunctionBelowground(psiSoilLayers1,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS12 = hydraulics.supplyFunctionBelowground(psiSoilLayers2,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS13 = hydraulics.supplyFunctionBelowground(psiSoilLayers3,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS14 = hydraulics.supplyFunctionBelowground(psiSoilLayers4,
                                  krhizomaxvec1,rep(n1,3),rep(alpha1,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS21 = hydraulics.supplyFunctionBelowground(psiSoilLayers1,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS22 = hydraulics.supplyFunctionBelowground(psiSoilLayers2,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS23 = hydraulics.supplyFunctionBelowground(psiSoilLayers3,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS24 = hydraulics.supplyFunctionBelowground(psiSoilLayers4,
                                  krhizomaxvec2,rep(n2,3),rep(alpha2,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS31 = hydraulics.supplyFunctionBelowground(psiSoilLayers1,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS32 = hydraulics.supplyFunctionBelowground(psiSoilLayers2,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS33 = hydraulics.supplyFunctionBelowground(psiSoilLayers3,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
supplyRS34 = hydraulics.supplyFunctionBelowground(psiSoilLayers4,
                                  krhizomaxvec3,rep(n3,3),rep(alpha3,3),
                                  krootmaxvec, rootc,rootd,
                                  maxNsteps = 400, psiMax = psiMax)
...
\begin{figure}[h!]
\includegraphics[width=\textwidth]{hydraulics_unsegmented.jpg}
\end{figure}
...
\begin{figure}[h!]
\includegraphics[width=\textwidth]{hydraulics_plc.jpg}
\end{figure}
...
\subsubsection{Symplastic compartments}
Stem symplastic storage compartments (e.g. xylem parenchyma) can contribute to sapflow dynamics by continuously exchanging water with xylem conduits. In \texttt{medfate}, there are many symplastic storage compartments as stem segments, and they can exchange water both vertically (between them and with the input and output flows of the stem) and laterally (potentially refilling xylem conduits). When lateral flows are inhibited xylem conduits are not refilled, but symplastic compartments can exchange water vertically, hence increase or decrease sapflow at the endpoints of the stem. hence, influence transpiration. If lateral 
...
\subsubsection{Disconnection from the soil}
\begin{figure}[h!]

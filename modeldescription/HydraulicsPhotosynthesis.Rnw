...
supplyRS11 = hydraulics.supplyFunctionBelowground(psiSoilLayers1,
                                  ...
                                  maxNsteps = 400,
                                  reverseFlowReduction = reversefr)
...
The following figures show the change in supply function caused by stem and leaf water compartments, assuming a 1-hr time step and either 0 MPa or -1.5 MPa as previous water potential for all segments (see function \texttt{hydraulics.supplyFunctionNetworkCapacitance()}):

...
#> [1] FALSE
#> 
#> $control$leafConductanceEstimation
#> [1] TRUE
#> 
#> $control$rootConductivityEstimation
#> [1] TRUE
#> 
...
#> $belowLayers$L
#>          1   2    3    4
#> T1_158 150 650 1500 3000
#> T2_179 150 650 1500 3000
#> S1_176 150 650 1500 3000
#> 
#> $belowLayers$Wpool
#>        1 2 3 4
#> T1_158 1 1 1 1
...
#> 
#> $belowLayers$RHOP$T2_179
#>                1         2         3         4
#> T1_158 0.5501030 0.5501030 0.5501030 0.5501030
#> T2_179 0.4146833 0.4146833 0.4146833 0.4146833
#> S1_176 0.0352137 0.0352137 0.0352137 0.0352137
#> 
#> $belowLayers$RHOP$S1_176
#>                1         2         3         4
#> T1_158 0.5501030 0.5501030 0.5501030 0.5501030
#> T2_179 0.4146833 0.4146833 0.4146833 0.4146833
#> S1_176 0.0352137 0.0352137 0.0352137 0.0352137
...
#> T1_158 oneflush-evergreen     2.083333    50  200     0 8268  12.5  28.5    2
#> T2_179 oneflush-evergreen     2.000000    50  200     0 8268  12.5  28.5    2
#> S1_176 oneflush-evergreen     1.341667    50  200     0 8268  12.5  28.5    2
#>        ysen
#> T1_158    2
#> T2_179    2
#> S1_176    2
...
#> T1_158 1982.660     1 4.990020   0.2881200        0.60       0.2881200
#> T2_179 1108.262     1 5.580754   0.6650000        0.89       0.6650000
#> S1_176 2436.475     1 7.152702   0.3669009        0.73       0.3669009
#>              SRL RLD     r635
#> T1_158 2115.0874  10 1.964226
#> T2_179  735.7025  10 1.805872
#> S1_176  996.2760  10 2.289452
#> 
#> $paramsInterception
#>        kPAR      kSWR   g
#> T1_158 0.50 0.3703704 1.0
#> T2_179 0.55 0.4074074 0.5
#> S1_176 0.55 0.4074074 0.5
#> 
#> $paramsTranspiration
#>              Gswmin  Tmax_LAI   Tmax_LAIsq Psi_Extract Exp_Extract VCleaf_c
#> T1_158 0.0006655459 0.1869849 -0.008372458  -0.9218219    1.504542 4.412593
#> T2_179 0.0028095533 0.1251027 -0.005601615  -1.9726871    1.149052 4.412593
#> S1_176 0.0104552469 0.1340000 -0.006000000  -1.5755945    1.300000 4.412593
#>         VCleaf_d VCstem_c  VCstem_d      WUE   WUE_par     WUE_co2    WUE_vpd
#> T1_158 -2.107019 5.760425 -5.477666 8.525550 0.5239136 0.002586327 -0.2647169
#> T2_179 -3.803127 8.087529 -7.198963 8.968208 0.1412266 0.002413091 -0.5664879
#> S1_176 -3.284789 3.071843 -7.887063 7.900000 0.3643000 0.002757000 -0.4636000
#> 
#> $paramsWaterStorage
...
#> T1_158 -1.9760 12.82234 0.9258273 2.7692165
#> T2_179 -3.1824 44.33022 0.6263370 2.8925043
...
#> T1_158  53.70000    21.55000 1.907817 1.289641          0.75 0.50      0.7
#> T2_179  36.00819    20.15953 1.513844 2.269906          0.75 0.55      0.7
#> S1_176  53.70000    21.55000 1.907817 1.289641          0.75 0.55      0.7
#>        gammaSWR   g
#> T1_158     0.14 1.0
#> T2_179     0.18 0.5
#> S1_176     0.18 0.5
...
#> T1_158     0     0       -0.033  -0.033  -0.033      -0.033      -0.033       0
#> T2_179     0     0       -0.033  -0.033  -0.033      -0.033      -0.033       0
#> S1_176     0     0       -0.033  -0.033  -0.033      -0.033      -0.033       0
#>        StemPLC
#> T1_158       0
#> T2_179       0
#> S1_176       0
...
#> $belowLayers$VGrhizo_kmax
#>                1         2          3           4
#> T1_158  21553222   1091688   40255.76    6311.503
#> T2_179 114793085 103265271 9315610.19 1801845.304
#> S1_176  88793115  35751768 4658629.02 1376928.653
#> 
#> $belowLayers$VCroot_kmax
#>               1         2           3            4
#> T1_158 3.097495 0.3589707 0.009700014 0.0007947957
...
#> T1_158 0.0006655459 0.04554533               3.000000         -1.939080
#> T2_179 0.0028095533 0.21575000               7.647559         -3.090000
#> S1_176 0.0104552469 0.17847825               4.867510         -3.022976
#>        Gsw_slope_Baldocchi  Vmax298   Jmax298 Kmax_stemxylem Kmax_rootxylem
#> T1_158            65.39617 69.30208 119.93960      0.4152667       1.661067
#> T2_179            46.23551 39.44837  93.30728      0.8268000       3.307200
#> S1_176            47.03891 58.79590 104.34879      0.2900000       1.160000
#>        VCleaf_kmax VCleafapo_kmax VCleaf_slope VCleaf_P50 VCleaf_c  VCleaf_d
#> T1_158    1.261346       2.522693     43.65232      -5.14 5.760425 -5.477666
#> T2_179    5.334302      10.668605     21.11111      -6.88 8.087529 -7.198963
#> S1_176    2.191344       4.382687     12.20615      -7.00 3.071843 -7.887063
#>        kleaf_symp VCstem_kmax VCstem_slope VCstem_P50 VCstem_c  VCstem_d
#> T1_158   2.522693    2.423697     43.65232      -5.14 5.760425 -5.477666
#> T2_179  10.668605   11.288633     21.11111      -6.88 8.087529 -7.198963
#> S1_176   4.382687    7.473393     12.20615      -7.00 3.071843 -7.887063
#>        kstem_symp VCroot_kmax VCroot_slope VCroot_P50 VCroot_c  VCroot_d
#> T1_158       0.26    3.466961     43.65232      -5.14 5.760425 -5.477666
#> T2_179       0.26    3.792592     21.11111      -6.88 8.087529 -7.198963
#> S1_176       0.26    3.497202     12.20615      -7.00 3.071843 -7.887063
#>        VGrhizo_kmax Plant_kmax   FR_leaf   FR_stem   FR_root
#> T1_158     22691478  0.6694187 0.5307175 0.2761973 0.1930852
#> T2_179    229175811  1.8528039 0.3473376 0.1641301 0.4885323
#> S1_176    130580441  1.1414327 0.5208826 0.1527329 0.3263846
#> 
#> $paramsWaterStorage
#>           maxFMC maxMCleaf maxMCstem   LeafPI0  LeafEPS    LeafAF     Vleaf
#> T1_158 122.16441  142.2755 101.30719 -1.236151 10.52923 0.3447917 0.5654136
...
#> T1_158     0     0    0      0      0       -0.033  -0.033  -0.033      -0.033
#> T2_179     0     0    0      0      0       -0.033  -0.033  -0.033      -0.033
#> S1_176     0     0    0      0      0       -0.033  -0.033  -0.033      -0.033
...
#> $above
#>          H   CR LAI_live LAI_expanded LAI_dead LAI_mistletoe Age ObsID
#> T1_158 800 0.66     0.80         0.80        0             0  NA  <NA>
#> T2_179 660 0.60     0.50         0.50        0             0  NA  <NA>
#> S1_176  80 0.80     0.03         0.03        0             0  NA  <NA>
#> 
#> $below
#>        Z50  Z95 Z100 poolProportions
#> T1_158 100  300   NA      0.60150376
#> T2_179 300 1000   NA      0.37593985
#> S1_176 200 1000   NA      0.02255639
#> 
#> $belowLayers
#> $belowLayers$V
#>                1          2           3            4
...
#> $belowLayers$RHOP$T1_158
#>                 1          2          3          4
#> T1_158 0.60150376 0.60150376 0.60150376 0.60150376
#> T2_179 0.37593985 0.37593985 0.37593985 0.37593985
#> S1_176 0.02255639 0.02255639 0.02255639 0.02255639
#> 
#> $belowLayers$RHOP$T2_179
#>                 1          2          3          4
#> T1_158 0.60150376 0.60150376 0.60150376 0.60150376

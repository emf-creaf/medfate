...
\begin{center}\includegraphics{medfatebook_files/figure-latex/unnamed-chunk-85-1} \end{center}
...
\begin{center}\includegraphics{medfatebook_files/figure-latex/unnamed-chunk-96-1} \end{center}

...
// DAYCENTsnags
NumericVector DAYCENTsnags(DataFrame snags, NumericVector baseAnnualRates, DataFrame paramsLitterDecomposition, DataFrame paramsAnatomy, double airTemperature, double airRelativeHumidity, double tstep);
RcppExport SEXP _medfate_DAYCENTsnags(SEXP snagsSEXP, SEXP baseAnnualRatesSEXP, SEXP paramsLitterDecompositionSEXP, SEXP paramsAnatomySEXP, SEXP airTemperatureSEXP, SEXP airRelativeHumiditySEXP, SEXP tstepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< DataFrame >::type paramsAnatomy(paramsAnatomySEXP);
    Rcpp::traits::input_parameter< double >::type airTemperature(airTemperatureSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(DAYCENTsnags(snags, baseAnnualRates, paramsLitterDecomposition, paramsAnatomy, airTemperature, airRelativeHumidity, tstep));
    return rcpp_result_gen;
END_RCPP
}
// DAYCENTlitter
...
// DAYCENT
List DAYCENT(DataFrame snags, DataFrame litter, NumericVector SOC, DataFrame paramsLitterDecomposition, DataFrame paramsAnatomy, NumericVector baseAnnualRates, double annualTurnoverRate, DataFrame environmentalConditions, DataFrame litterProduction, double sand, double clay, double soilPH, double soilO2, double cultfac, double tstep, bool balanceCheck);
RcppExport SEXP _medfate_DAYCENT(SEXP snagsSEXP, SEXP litterSEXP, SEXP SOCSEXP, SEXP paramsLitterDecompositionSEXP, SEXP paramsAnatomySEXP, SEXP baseAnnualRatesSEXP, SEXP annualTurnoverRateSEXP, SEXP environmentalConditionsSEXP, SEXP litterProductionSEXP, SEXP sandSEXP, SEXP claySEXP, SEXP soilPHSEXP, SEXP soilO2SEXP, SEXP cultfacSEXP, SEXP tstepSEXP, SEXP balanceCheckSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< DataFrame >::type snags(snagsSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(DAYCENT(snags, litter, SOC, paramsLitterDecomposition, paramsAnatomy, baseAnnualRates, annualTurnoverRate, environmentalConditions, litterProduction, sand, clay, soilPH, soilO2, cultfac, tstep, balanceCheck));
    return rcpp_result_gen;
END_RCPP
}
...
double averageRhizosphereResistancePercent_c(double krhizomax, double n, double alpha, double krootmax, double rootc, double rootd, double kstemmax, double stemc, double stemd, double kleafmax, double leafc, double leafd, double psiMin, double psiStep);
RcppExport SEXP _medfate_averageRhizosphereResistancePercent_c(SEXP krhizomaxSEXP, SEXP nSEXP, SEXP alphaSEXP, SEXP krootmaxSEXP, SEXP rootcSEXP, SEXP rootdSEXP, SEXP kstemmaxSEXP, SEXP stemcSEXP, SEXP stemdSEXP, SEXP kleafmaxSEXP, SEXP leafcSEXP, SEXP leafdSEXP, SEXP psiMinSEXP, SEXP psiStepSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type krhizomax(krhizomaxSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type leafc(leafcSEXP);
    Rcpp::traits::input_parameter< double >::type leafd(leafdSEXP);
    Rcpp::traits::input_parameter< double >::type psiMin(psiMinSEXP);
    Rcpp::traits::input_parameter< double >::type psiStep(psiStepSEXP);
    rcpp_result_gen = Rcpp::wrap(averageRhizosphereResistancePercent_c(krhizomax, n, alpha, krootmax, rootc, rootd, kstemmax, stemc, stemd, kleafmax, leafc, leafd, psiMin, psiStep));
    return rcpp_result_gen;
END_RCPP
}
// findRhizosphereMaximumConductance_c
double findRhizosphereMaximumConductance_c(double averageResistancePercent, double n, double alpha, double krootmax, double rootc, double rootd, double kstemmax, double stemc, double stemd, double kleafmax, double leafc, double leafd, double psiMin, double initialValue);
RcppExport SEXP _medfate_findRhizosphereMaximumConductance_c(SEXP averageResistancePercentSEXP, SEXP nSEXP, SEXP alphaSEXP, SEXP krootmaxSEXP, SEXP rootcSEXP, SEXP rootdSEXP, SEXP kstemmaxSEXP, SEXP stemcSEXP, SEXP stemdSEXP, SEXP kleafmaxSEXP, SEXP leafcSEXP, SEXP leafdSEXP, SEXP psiMinSEXP, SEXP initialValueSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(findRhizosphereMaximumConductance_c(averageResistancePercent, n, alpha, krootmax, rootc, rootd, kstemmax, stemc, stemd, kleafmax, leafc, leafd, psiMin, initialValue));
    return rcpp_result_gen;
END_RCPP
}
// taperFactorSavage_c
...
// aspwbDay
List aspwbDay(List x, CharacterVector date, NumericVector meteovec, double latitude, double elevation, double slope, double aspect, double runon, Nullable<NumericVector> lateralFlows, double waterTableDepth, bool modifyInput);
static SEXP _medfate_aspwbDay_try(SEXP xSEXP, SEXP dateSEXP, SEXP meteovecSEXP, SEXP latitudeSEXP, SEXP elevationSEXP, SEXP slopeSEXP, SEXP aspectSEXP, SEXP runonSEXP, SEXP lateralFlowsSEXP, SEXP waterTableDepthSEXP, SEXP modifyInputSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< List >::type x(xSEXP);
    Rcpp::traits::input_parameter< CharacterVector >::type date(dateSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type waterTableDepth(waterTableDepthSEXP);
    Rcpp::traits::input_parameter< bool >::type modifyInput(modifyInputSEXP);
    rcpp_result_gen = Rcpp::wrap(aspwbDay(x, date, meteovec, latitude, elevation, slope, aspect, runon, lateralFlows, waterTableDepth, modifyInput));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _medfate_aspwbDay(SEXP xSEXP, SEXP dateSEXP, SEXP meteovecSEXP, SEXP latitudeSEXP, SEXP elevationSEXP, SEXP slopeSEXP, SEXP aspectSEXP, SEXP runonSEXP, SEXP lateralFlowsSEXP, SEXP waterTableDepthSEXP, SEXP modifyInputSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_medfate_aspwbDay_try(xSEXP, dateSEXP, meteovecSEXP, latitudeSEXP, elevationSEXP, slopeSEXP, aspectSEXP, runonSEXP, lateralFlowsSEXP, waterTableDepthSEXP, modifyInputSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
RcppExport SEXP _medfate_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("medfate", "_medfate_.copy_model_output", (DL_FUNC)_medfate_copyModelOutput_try);
    ...
    R_RegisterCCallable("medfate", "_medfate_aspwb_day", (DL_FUNC)_medfate_aspwbDay_try);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_medfate_DAYCENTsnags", (DL_FUNC) &_medfate_DAYCENTsnags, 7},
    ...
    {"_medfate_averageRhizosphereResistancePercent_c", (DL_FUNC) &_medfate_averageRhizosphereResistancePercent_c, 14},
    {"_medfate_findRhizosphereMaximumConductance_c", (DL_FUNC) &_medfate_findRhizosphereMaximumConductance_c, 14},
    ...
    {"_medfate_aspwbDay", (DL_FUNC) &_medfate_aspwbDay, 11},

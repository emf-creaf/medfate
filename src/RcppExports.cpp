...
// horizontalRootProportions
List horizontalRootProportions(NumericMatrix V, NumericVector LAIlive, double poolOverlapFactor);
RcppExport SEXP _medfate_horizontalRootProportions(SEXP VSEXP, SEXP LAIliveSEXP, SEXP poolOverlapFactorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type V(VSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(horizontalRootProportions(V, LAIlive, poolOverlapFactor));
    return rcpp_result_gen;
END_RCPP
}
// thetaSATSaxton
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_medfate_horizontalRootProportions", (DL_FUNC) &_medfate_horizontalRootProportions, 3},

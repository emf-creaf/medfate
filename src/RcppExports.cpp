...
// horizontalOverlapProportions
List horizontalOverlapProportions(NumericMatrix V, NumericVector LAIlive, double poolOverlapFactor);
RcppExport SEXP _medfate_horizontalOverlapProportions(SEXP VSEXP, SEXP LAIliveSEXP, SEXP poolOverlapFactorSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type V(VSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(horizontalOverlapProportions(V, LAIlive, poolOverlapFactor));
    return rcpp_result_gen;
END_RCPP
}
// thetaSATSaxton
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_medfate_horizontalOverlapProportions", (DL_FUNC) &_medfate_horizontalOverlapProportions, 3},

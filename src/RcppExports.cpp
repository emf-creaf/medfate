...
// E2psiBelowground
List E2psiBelowground(double E, NumericVector psiSoil, NumericVector krhizomax, NumericVector nsoil, NumericVector alphasoil, NumericVector krootmax, double rootc, double rootd, NumericVector psiIni, int ntrial, double psiTol, double ETol, double reverseFlowReduction);
RcppExport SEXP _medfate_E2psiBelowground(SEXP ESEXP, SEXP psiSoilSEXP, SEXP krhizomaxSEXP, SEXP nsoilSEXP, SEXP alphasoilSEXP, SEXP krootmaxSEXP, SEXP rootcSEXP, SEXP rootdSEXP, SEXP psiIniSEXP, SEXP ntrialSEXP, SEXP psiTolSEXP, SEXP ETolSEXP, SEXP reverseFlowReductionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type E(ESEXP);
    ...
    Rcpp::traits::input_parameter< double >::type reverseFlowReduction(reverseFlowReductionSEXP);
    rcpp_result_gen = Rcpp::wrap(E2psiBelowground(E, psiSoil, krhizomax, nsoil, alphasoil, krootmax, rootc, rootd, psiIni, ntrial, psiTol, ETol, reverseFlowReduction));
    return rcpp_result_gen;
END_RCPP
}
// E2psiAboveground
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type ETol(ETolSEXP);
    Rcpp::traits::input_parameter< double >::type reverseFlowReduction(reverseFlowReductionSEXP);
    rcpp_result_gen = Rcpp::wrap(E2psiNetworkCapacitance(E, psiSoil, psiStemPrev, PLCstem, psiLeafPrev, krhizomax, nsoil, alphasoil, krootmax, rootc, rootd, kstemmax, stemc, stemd, kleafmax, leafc, leafd, Vsapwood, stemfapo, stempi0, stemeps, Vleaf, leaffapo, leafpi0, leafeps, tstep, psiIni, ntrial, psiTol, ETol, reverseFlowReduction));
    return rcpp_result_gen;
END_RCPP
}
...
List supplyFunctionBelowground(NumericVector psiSoil, NumericVector krhizomax, NumericVector nsoil, NumericVector alphasoil, NumericVector krootmax, double rootc, double rootd, double minFlow, int maxNsteps, int ntrial, double psiTol, double ETol, double pCrit, double reverseFlowReduction);
RcppExport SEXP _medfate_supplyFunctionBelowground(SEXP psiSoilSEXP, SEXP krhizomaxSEXP, SEXP nsoilSEXP, SEXP alphasoilSEXP, SEXP krootmaxSEXP, SEXP rootcSEXP, SEXP rootdSEXP, SEXP minFlowSEXP, SEXP maxNstepsSEXP, SEXP ntrialSEXP, SEXP psiTolSEXP, SEXP ETolSEXP, SEXP pCritSEXP, SEXP reverseFlowReductionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type psiSoil(psiSoilSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type pCrit(pCritSEXP);
    Rcpp::traits::input_parameter< double >::type reverseFlowReduction(reverseFlowReductionSEXP);
    rcpp_result_gen = Rcpp::wrap(supplyFunctionBelowground(psiSoil, krhizomax, nsoil, alphasoil, krootmax, rootc, rootd, minFlow, maxNsteps, ntrial, psiTol, ETol, pCrit, reverseFlowReduction));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type pCrit(pCritSEXP);
    Rcpp::traits::input_parameter< double >::type reverseFlowReduction(reverseFlowReductionSEXP);
    rcpp_result_gen = Rcpp::wrap(supplyFunctionNetwork(psiSoil, krhizomax, nsoil, alphasoil, krootmax, rootc, rootd, kstemmax, stemc, stemd, kleafmax, leafc, leafd, PLCstem, minFlow, maxNsteps, ntrial, psiTol, ETol, pCrit, reverseFlowReduction));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_medfate_E2psiBelowground", (DL_FUNC) &_medfate_E2psiBelowground, 13},
    ...
    {"_medfate_E2psiNetwork", (DL_FUNC) &_medfate_E2psiNetwork, 20},
    {"_medfate_E2psiNetworkCapacitance", (DL_FUNC) &_medfate_E2psiNetworkCapacitance, 31},
    ...
    {"_medfate_supplyFunctionNetworkCapacitance", (DL_FUNC) &_medfate_supplyFunctionNetworkCapacitance, 32},

...
namespace medfate {
    ...
    inline NumericVector hydrology_soilWaterBalance(List soil, String soilFunctions, double rainfallInput, double rainfallIntensity, double snowmelt, NumericVector sourceSink, String infiltrationMode = "GreenAmpt1911", String soilDomains = "single", bool freeDrainage = true, int nsteps = 24, bool modifySoil = true) {
        typedef SEXP(*Ptr_hydrology_soilWaterBalance)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_hydrology_soilWaterBalance p_hydrology_soilWaterBalance = NULL;
        if (p_hydrology_soilWaterBalance == NULL) {
            validateSignature("NumericVector(*hydrology_soilWaterBalance)(List,String,double,double,double,NumericVector,String,String,bool,int,bool)");

...
namespace medfate {
    ...
    inline double mortality_dailyProbability(double stressValue, double stressThreshold, double exponent = 40.0) {
        typedef SEXP(*Ptr_mortality_dailyProbability)(SEXP,SEXP,SEXP);
        static Ptr_mortality_dailyProbability p_mortality_dailyProbability = NULL;
        if (p_mortality_dailyProbability == NULL) {
            validateSignature("double(*mortality_dailyProbability)(double,double,double)");
        ...
        RObject rcpp_result_gen;
        {
            ...
            rcpp_result_gen = p_mortality_dailyProbability(Shield<SEXP>(Rcpp::wrap(stressValue)), Shield<SEXP>(Rcpp::wrap(stressThreshold)), Shield<SEXP>(Rcpp::wrap(exponent)));
        }

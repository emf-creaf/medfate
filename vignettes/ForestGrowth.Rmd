...
This document describes how to run a growth model of `medfate`. This document is meant to teach users to run the simulation model within R. All the details of the model design and formulation can be found at https://vegmod.github.io/software/medfate. 

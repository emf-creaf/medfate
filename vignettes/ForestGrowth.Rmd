...
This document describes how to run the growth model of `medfate`, implemented in function `growth()`. All the details of the model design and formulation can be found at https://vegmod.github.io/software/medfate/. 

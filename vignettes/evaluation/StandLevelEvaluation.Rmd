---
title: "Stand-level evaluation results"
...
source("~/OneDrive/Professional/MedfateWorks/MedfateValidation/main_script.R")
```


```{r setup, include=FALSE}
params = list(wd='/home/miquel/OneDrive/Professional/MedfateWorks/MedfateValidation/',
              model='spwb',
              conf='advanced',
              save_plots = FALSE)

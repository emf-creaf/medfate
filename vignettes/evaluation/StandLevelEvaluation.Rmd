...
Forest water balance simulations (i.e. function `spwb()`) have been conducted using the three transpiration modes (i.e. `Granier`, `Sperry` or `Cochard`). 
...
control_sperry <- yaml::yaml.load_file(system.file("yaml_configurations", "sperry.yaml",
                                          package = "medfatereports"))
control_cochard <- yaml::yaml.load_file(system.file("yaml_configurations", "cochard.yaml",
                                          package = "medfatereports"))
dplyr::bind_rows(as.data.frame(control_granier),
                 as.data.frame(control_sperry),
                 as.data.frame(control_cochard))
```

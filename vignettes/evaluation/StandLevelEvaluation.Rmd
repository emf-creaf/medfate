...
source("~/OneDrive/Professional/MEDFATE_development/StandLevelEvaluation/main_script.R")
```


```{r setup, include=FALSE}
params = list(wd='/home/miquel/OneDrive/Professional/MEDFATE_development/StandLevelEvaluation/',
              model='spwb',
              conf='advanced',
              save_plots = FALSE)

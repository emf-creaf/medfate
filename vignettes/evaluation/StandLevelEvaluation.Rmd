...
source("~/OneDrive/Professional/MedfateWorks/StandLevelEvaluation/main_script.R")
```


```{r setup, include=FALSE}
params = list(wd='/home/miquel/OneDrive/Professional/MedfateWorks/StandLevelEvaluation/',
              model='spwb',
              conf='advanced',
              save_plots = FALSE)

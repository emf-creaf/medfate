...
pc<-medfate::evaluation_plot(df_site$Result[[3]], df_site$SiteData[[3]]$measuredData, type= "REW", plotType = "scatter")+labs(subtitle="Cochard")+xlab("Modelled REW (%)")+ylab("Observed REW (%)")

...
An example of simulation with `growth()` is provided in vignette [*Forest growth*](https://emf-creaf.github.io/medfate/articles/runmodels/ForestGrowth.html). 
...
An example of simulation with `fordyn()` is provided in vignette [*Forest dynamics*](https://emf-creaf.github.io/medfate/articles/runmodels/ForestDynamics.html). 

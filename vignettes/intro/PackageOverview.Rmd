...
Currently, the package distributed from CRAN does not include any vignette. Articles covering model simulation examples, sensitivity analysis, parameter specification, model evaluation and applications can be found at the package [website](https://emf-creaf.github.io/medfate/). 

Complete documentation on the design and formulation of medfate models can be found at the [medfate reference book](https://emf-creaf.github.io/medfatebook/index.html). 

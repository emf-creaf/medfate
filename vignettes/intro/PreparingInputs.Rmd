...
output: 
  rmarkdown::html_vignette:
    toc: TRUE
vignette: >
  %\VignetteIndexEntry{Preparing model inputs}
...
Package [medfateutils](https://emf-creaf.github.io/medfateutils/) provides functions for creating suitable inputs for simulations with `medfate`.

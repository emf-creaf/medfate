...
Package vignettes only cover how to run models using the package functions. Complete documentation on the design and formulation of medfate models can be found in the [medfate reference book](https://vegmod.github.io/medfate/medfatebook/intro.html).

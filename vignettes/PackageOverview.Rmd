...
* **hydrology.* **: Canopy and soil hydrology (rainfall interception, soil evaporation, soil infiltration).
...
* **spwb.* **: Soil water balance parameter optimization/calibration routines.

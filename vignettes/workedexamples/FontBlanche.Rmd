...
```
Surprisingly, the absolute scales of the modeled and measured SMC do not match, so we can use relative extractable water, where in the case of observed data the function divides the observed values by the 95% quantile:
```{r, fig=TRUE, fig.align="center", fig.width=5, fig.height = 4}

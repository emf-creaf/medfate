...
```{r, echo = FALSE}
WB_FB_sperry_total = readRDS(paste0(base_pools,"data/Output/fb_sperry_total.rds"))
WB_FB_sperry_partial = readRDS(paste0(base_pools,"data/Output/fb_sperry_partial.rds"))
WB_FB_sperry_none = readRDS(paste0(base_pools,"data/Output/fb_sperry_none.rds"))
WB_PR_sperry_total = readRDS(paste0(base_pools,"data/Output/pr_sperry_total.rds"))
WB_PR_sperry_partial = readRDS(paste0(base_pools,"data/Output/pr_sperry_partial.rds"))
WB_PR_sperry_none = readRDS(paste0(base_pools,"data/Output/pr_sperry_none.rds"))
WB_PU_sperry_total = readRDS(paste0(base_pools,"data/Output/pu_sperry_total.rds"))
WB_PU_sperry_partial = readRDS(paste0(base_pools,"data/Output/pu_sperry_partial.rds"))
WB_PU_sperry_none = readRDS(paste0(base_pools,"data/Output/pu_sperry_none.rds"))
# WB_CB_sperry_total = readRDS(paste0(base_pools,"data/Output/cb_sperry_total.rds"))
# WB_CB_sperry_partial = readRDS(paste0(base_pools,"data/Output/cb_sperry_partial.rds"))
# WB_CB_sperry_none = readRDS(paste0(base_pools,"data/Output/cb_sperry_none.rds"))
WB_ES_sperry_total = readRDS(paste0(base_pools,"data/Output/es_sperry_total.rds"))
WB_ES_sperry_partial = readRDS(paste0(base_pools,"data/Output/es_sperry_partial.rds"))
WB_ES_sperry_none = readRDS(paste0(base_pools,"data/Output/es_sperry_none.rds"))
# WB_RO_sperry_total = readRDS(paste0(base_pools,"data/Output/ro_sperry_total.rds"))
# WB_RO_sperry_partial = readRDS(paste0(base_pools,"data/Output/ro_sperry_partial.rds"))
# WB_RO_sperry_none = readRDS(paste0(base_pools,"data/Output/ro_sperry_none.rds"))

WB_FB_granier_total = readRDS(paste0(base_pools,"data/Output/fb_granier_total.rds"))
WB_FB_granier_partial = readRDS(paste0(base_pools,"data/Output/fb_granier_partial.rds"))
WB_FB_granier_none = readRDS(paste0(base_pools,"data/Output/fb_granier_none.rds"))
WB_PR_granier_total = readRDS(paste0(base_pools,"data/Output/pr_granier_total.rds"))
WB_PR_granier_partial = readRDS(paste0(base_pools,"data/Output/pr_granier_partial.rds"))
WB_PR_granier_none = readRDS(paste0(base_pools,"data/Output/pr_granier_none.rds"))
WB_PU_granier_total = readRDS(paste0(base_pools,"data/Output/pu_granier_total.rds"))
WB_PU_granier_partial = readRDS(paste0(base_pools,"data/Output/pu_granier_partial.rds"))
WB_PU_granier_none = readRDS(paste0(base_pools,"data/Output/pu_granier_none.rds"))
# WB_CB_granier_total = readRDS(paste0(base_pools,"data/Output/cb_granier_total.rds"))
# WB_CB_granier_partial = readRDS(paste0(base_pools,"data/Output/cb_granier_partial.rds"))
# WB_CB_granier_none = readRDS(paste0(base_pools,"data/Output/cb_granier_none.rds"))
WB_ES_granier_total = readRDS(paste0(base_pools,"data/Output/es_granier_total.rds"))
WB_ES_granier_partial = readRDS(paste0(base_pools,"data/Output/es_granier_partial.rds"))
WB_ES_granier_none = readRDS(paste0(base_pools,"data/Output/es_granier_none.rds"))
# WB_RO_granier_total = readRDS(paste0(base_pools,"data/Output/ro_granier_total.rds"))
# WB_RO_granier_partial = readRDS(paste0(base_pools,"data/Output/ro_granier_partial.rds"))
# WB_RO_granier_none = readRDS(paste0(base_pools,"data/Output/ro_granier_none.rds"))

WB_FB_sureau_total = readRDS(paste0(base_pools,"data/Output/fb_sureau_total.rds"))
WB_FB_sureau_partial = readRDS(paste0(base_pools,"data/Output/fb_sureau_partial.rds"))
WB_FB_sureau_none = readRDS(paste0(base_pools,"data/Output/fb_sureau_none.rds"))
WB_PR_sureau_total = readRDS(paste0(base_pools,"data/Output/pr_sureau_total.rds"))
WB_PR_sureau_partial = readRDS(paste0(base_pools,"data/Output/pr_sureau_partial.rds"))
WB_PR_sureau_none = readRDS(paste0(base_pools,"data/Output/pr_sureau_none.rds"))
WB_PU_sureau_total = readRDS(paste0(base_pools,"data/Output/pu_sureau_total.rds"))
WB_PU_sureau_partial = readRDS(paste0(base_pools,"data/Output/pu_sureau_partial.rds"))
WB_PU_sureau_none = readRDS(paste0(base_pools,"data/Output/pu_sureau_none.rds"))
# WB_CB_sureau_total = readRDS(paste0(base_pools,"data/Output/cb_sureau_total.rds"))
# WB_CB_sureau_partial = readRDS(paste0(base_pools,"data/Output/cb_sureau_partial.rds"))
# WB_CB_sureau_none = readRDS(paste0(base_pools,"data/Output/cb_sureau_none.rds"))
WB_ES_sureau_total = readRDS(paste0(base_pools,"data/Output/es_sureau_total.rds"))
WB_ES_sureau_partial = readRDS(paste0(base_pools,"data/Output/es_sureau_partial.rds"))
WB_ES_sureau_none = readRDS(paste0(base_pools,"data/Output/es_sureau_none.rds"))
# WB_RO_sureau_total = readRDS(paste0(base_pools,"data/Output/ro_sureau_total.rds"))
# WB_RO_sureau_partial = readRDS(paste0(base_pools,"data/Output/ro_sureau_partial.rds"))
# WB_RO_sureau_none = readRDS(paste0(base_pools,"data/Output/ro_sureau_none.rds"))
```

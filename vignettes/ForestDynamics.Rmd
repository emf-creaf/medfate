...
In this vignette we will fake a eight-year weather input by repeating the example weather data frame eight times.
```{r}
meteo_01_08 = rbind(examplemeteo, examplemeteo, examplemeteo, examplemeteo,

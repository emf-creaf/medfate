...
In this vignette we will fake a three-year weather input by repeating the example weather data frame four times, while reducing precipitation of the second and fourth years to the half.
```{r}
meteo2001 = examplemeteo
meteo2002 = examplemeteo
meteo2003 = examplemeteo
meteo2004 = examplemeteo[]
meteo2002$Precipitation = meteo2002$Precipitation/2
meteo2004$Precipitation = meteo2004$Precipitation/2
...
row.names(meteo2004) = seq(as.Date("2004-01-01"), 
                           as.Date("2004-12-30"), by="day")
meteo_01_04 = rbind(meteo2001, meteo2002, meteo2003, meteo2004)
```
...
```{r}
fd<-fordyn(exampleforestMED, examplesoil, SpParamsMED, meteo_01_04, control, 

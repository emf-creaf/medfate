...
As an example data set we will use here the same data sets provided to illustrate simulation functions in **medfate**. This data set consists of a forest with two tree species (*Pinus halepensis*/T1_157 and *Quercus ilex*/T2_176) and one shrub species (*Quercus coccifera*/S1_174 or Kermes oak). 
...
parNames = c("T1_157/LAI_live", "T2_176/LAI_live", "S1_174/LAI_live",
             "T1_157/Z50", "T2_176/Z50", "S1_174/Z50",
             "T1_157/Psi_Extract", "T2_176/Psi_Extract", "S1_174/Psi_Extract",
             "rfc@1", "rfc@2")
...
```{r}
#Parameter names of interest
parNames = c("T1_157/Z50", "T2_176/Z50", "S1_174/Z50")
#Parameter minimum and maximum values

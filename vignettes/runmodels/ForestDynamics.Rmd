...
Model inputs are explained in greater detail in vignettes [*Understanding model inputs*](https://emf-creaf.github.io/medfate/articles/UnderstandingInputs.html) and [*Preparing model inputs*](https://emf-creaf.github.io/medfate/articles/PreparingInputs.html). Here we only review the different steps required to run function `fordyn()`.

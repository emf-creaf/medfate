...
### Target parameters for calibration
  ...
  b. **Sapwood maximum relative growth rate (RGRsapwoodmax)** - Used to modulate daily sapwood relative growth rate variations. Actual relative growth rates include temperature and sink limitations to growth.
  c. **Sapwood daily senescence rate (SRsapwood)** - Used to modulate daily sapwood relative growth rate variations. Actual relative growth rates include temperature and sink limitations to growth.

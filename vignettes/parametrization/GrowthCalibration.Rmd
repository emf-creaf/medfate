...
plot_desc = readRDS(paste0(base_calibration,"data/SpParamsMED/output/plot_desc_FUN2FUN.rds"))
obs_FUN2FUN = readRDS(paste0(base_calibration,"data/SpParamsMED/output/obs_FUN2FUN_IFN.rds"))
...
cal_FUN2FUN_SL_ga = readRDS(paste0(base_calibration,"data/SpParamsMED/output/cal_FUN2FUN_SL_ga.rds"))
cal_FUN2FUN_NSL_ga = readRDS(paste0(base_calibration,"data/SpParamsMED/output/cal_FUN2FUN_NSL_ga.rds"))

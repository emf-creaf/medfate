...
library(medfate)
library(nlme)
meta_dir <- "/home/miquel/OneDrive/mcaceres_work/model_development/medfate_development/Metamodelling_TR_WUE/"
```
...
```{r, echo = FALSE}
df_par = readRDS(paste0(meta_dir,"Rdata/metamodelling_params.rds"))

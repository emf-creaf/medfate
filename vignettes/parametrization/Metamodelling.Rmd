...
The metamodelling procedure could be applied to any target species, but we focused on the main tree species in Catalonia: *Pinus halepensis*, *Pinus sylvestris*, *Pinus nigra*, *Pinus uncinata*, *Pinus pinea*, *Quercus ilex*, *Quercus pubescens*, *Quercus faginea*,  *Quercus suber*, *Fagus sylvatica* and *Abies alba*.
...
The table containing the four parameters estimated via meta-modelling is the following:
```{r, echo = FALSE}

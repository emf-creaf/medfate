...
TRY_Z95 <-TRY_Z95[TRY_Z95$OriglName %in% c("Max Rooting Depth (m)",
                                           ...
                                           "Rooting depth_max",
                                           "RootDepth"),]
TRY_Z95 <- TRY_Z95[TRY_Z95$ErrorRisk < 4, c("AccSpeciesName", "StdValue")]
...
TRY_LeafDuration <- TRY_LeafDuration[TRY_LeafDuration$ErrorRisk<4, c("AccSpeciesName", "StdValue")]
...
TRY_LeafDensity<- TRY_LeafDensity[TRY_LeafDensity$ErrorRisk < 4,, drop= FALSE] 
...
TRY_WoodDensity <- TRY_WoodDensity[TRY_WoodDensity$ErrorRisk<4, c("AccSpeciesName", "StdValue")]
...
TRY_Al2As <- TRY_Al2As[TRY_Al2As$ErrorRisk <4, c("AccSpeciesName", "StdValue")]
...
SpParams <- populateTraits(SpParams, TRY_LW[TRY_LW$ErrorRisk<4,],
...
SpParams <- populateTraits(SpParams, TRY_SRL[TRY_SRL$ErrorRisk<4,], 
...
TRY_LeafPI0 <- TRY_LeafPI0[TRY_LeafPI0$ErrorRisk<4, c("AccSpeciesName", "StdValue")]
...
SpParams <- populateTraits(SpParams, TRY_Lignin[TRY_Lignin$ErrorRisk<4,], 
...
TRY_WUE <- TRY_WUE %>% filter(StdValue < 40, ErrorRisk <4)
...
TRY_Narea <- TRY_Narea[TRY_Narea$ErrorRisk<4, c("AccSpeciesName", "StdValue")]
...
SpParams <- populateTraits(SpParams, TRY_Vmax298[TRY_Vmax298$ErrorRisk<4, ], 
...
SpParams <- populateTraits(SpParams, TRY_Jmax298[TRY_Jmax298$ErrorRisk<4, ], 
...
SpParams <- populateTraits(SpParams, TRY_WoodC[TRY_WoodC$ErrorRisk<4,], 

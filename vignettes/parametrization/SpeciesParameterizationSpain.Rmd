...
### Leaf area to sapwood area ratio ($1/H_v$)
...
### Critical water potential ($\Psi_{critic}$)
...
### Minimum/maximum stomatal conductance ($G_{swmin}$ and $G_{swmax}$)
...
### Stem maximum hydraulic conductivity ($K_{stem, max, ref}$) 

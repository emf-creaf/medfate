...
test_that("Can produce all basic spwb plots and summaries",{
  ...
  plot_types <- c("PET_Precipitation", "PET_NetRain", "Snow", "Export", 
                  "Evapotranspiration", "SoilPsi", "SoilRWC", "SoilREW", "SoilTheta", "SoilVol", "PlantExtraction", "HydraulicRedistribution", "LAI", "GroundIrradiance", "PlantLAI", "PlantLAIlive", "PlantTranspiration", "TranspirationPerLeaf", "PlantWaterBalance", "PlantGrossPhotosynthesis", "GrossPhotosynthesisPerLeaf", "FPAR", "AbsorbedSWRFraction", "PlantPsi", "StemRWC", "LeafRWC", "LFMC", "PlantStress", "LeafPLC", "StemPLC")
  for(type in plot_types) {
    expect_s3_class(plot(S1, type), "ggplot")
    expect_s3_class(plot(S1, type, summary.freq = "weeks"), "ggplot")
  }
  expect_type(summary(S1, output = "WaterBalance"), "double")
  expect_type(summary(S1, output = "RWC"), "double")
  ...
  expect_type(summary(S1, output = "LeafPLC"), "double")
...
test_that("Can produce all advanced spwb plots and summaries",{
  for(transpirationMode in c("Sperry", "Sureau")) {
    ...
    expect_type(resistances(S2, cohort = coh_1, draw=FALSE), "list")
...
test_that("Can produce all advanced subdaily spwb plots",{
  for(transpirationMode in c("Sperry", "Sureau")) {
    ...
    expect_s3_class(medfate:::.extractSubdaily(S2, output="Ag"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="An"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="dEdP"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="RootPsi"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="StemPsi"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="StemPLC"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="StemRWC"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="LeafRWC"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="StemSympRWC"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="LeafSympRWC"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="PWB"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="Temperature"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="ExtractionInst"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Abs_PAR"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Abs_SWR"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Net_LWR"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$E"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Ag"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$An"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Ci"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Gsw"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$VPD"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Temp"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$Psi"), "data.frame")
    expect_s3_class(medfate:::.extractSubdaily(S2, output="SunlitLeaves$iWUE"), "data.frame")    
  }    
})
...
test_that("Can produce all advanced growth plots and summaries",{
  for(transpirationMode in c("Sperry", "Sureau")) {
    ...
    expect_type(resistances(G2, cohort = coh_1, draw=FALSE), "list")
  }  
})
...
test_that("Can produce all fordyn plots",{
  ...
  expect_s3_class(plot(fd, "PET_Precipitation"), "ggplot")
  expect_s3_class(plot(fd, "PET_NetRain"), "ggplot")
  expect_s3_class(plot(fd, "Snow"), "ggplot")
  expect_s3_class(plot(fd, "Export"), "ggplot")
  expect_s3_class(plot(fd, "Evapotranspiration"), "ggplot")
  expect_s3_class(plot(fd, "SoilPsi"), "ggplot")
  expect_s3_class(plot(fd, "SoilREW"), "ggplot")
  expect_s3_class(plot(fd, "SoilRWC"), "ggplot")
  expect_s3_class(plot(fd, "SoilTheta"), "ggplot")
  expect_s3_class(plot(fd, "SoilVol"), "ggplot")
  expect_s3_class(plot(fd, "PlantExtraction"), "ggplot")
  expect_s3_class(plot(fd, "HydraulicRedistribution"), "ggplot")
  expect_s3_class(plot(fd, "LAI"), "ggplot")
  expect_s3_class(plot(fd, "PlantLAI"), "ggplot")
  expect_s3_class(plot(fd, "PlantLAIlive"), "ggplot")
  expect_s3_class(plot(fd, "PlantStress"), "ggplot")
  expect_s3_class(plot(fd, "LeafPLC"), "ggplot")
  expect_s3_class(plot(fd, "StemPLC"), "ggplot")
  expect_s3_class(plot(fd, "PlantPsi"), "ggplot")
  expect_s3_class(plot(fd, "PlantTranspiration"), "ggplot")
  expect_s3_class(plot(fd, "TranspirationPerLeaf"), "ggplot")
  ...
  expect_s3_class(plot(fd, "LabileCarbonBalance"), "ggplot")
  expect_s3_class(plot(fd, "SugarLeaf"), "ggplot")
  expect_s3_class(plot(fd, "StarchLeaf"), "ggplot")
  expect_s3_class(plot(fd, "SugarSapwood"), "ggplot")
  expect_s3_class(plot(fd, "StarchSapwood"), "ggplot")
  expect_s3_class(plot(fd, "SugarTransport"), "ggplot")
  expect_s3_class(plot(fd, "RootExudation"), "ggplot")
  expect_s3_class(plot(fd, "StructuralBiomassBalance"), "ggplot")
  expect_s3_class(plot(fd, "LabileBiomassBalance"), "ggplot")
  expect_s3_class(plot(fd, "PlantBiomassBalance"), "ggplot")
  expect_s3_class(plot(fd, "MortalityBiomassLoss"), "ggplot")
  expect_s3_class(plot(fd, "CohortBiomassBalance"), "ggplot")
  expect_s3_class(plot(fd, "SapwoodArea"), "ggplot")
  expect_s3_class(plot(fd, "LeafArea"), "ggplot")
  expect_s3_class(plot(fd, "FineRootBiomass"), "ggplot")
  expect_s3_class(plot(fd, "DBH"), "ggplot")
  expect_s3_class(plot(fd, "Height"), "ggplot")
  expect_s3_class(plot(fd, "SAgrowth"), "ggplot")
  expect_s3_class(plot(fd, "LAgrowth"), "ggplot")
  expect_s3_class(plot(fd, "HuberValue"), "ggplot")

...
test_that("Can produce all basic growth plots and summaries",{
  ...
  expect_s3_class(plot(G1, "GrowthBiomassIncrement"), "ggplot")
  expect_s3_class(plot(G1, "SenescenceBiomassLoss"), "ggplot")
  expect_s3_class(plot(G1, "LabileBiomassChange"), "ggplot")
  ...
  expect_s3_class(plot(G1, "SapwoodStructuralBiomass"), "ggplot")
  expect_s3_class(plot(G1, "LeafStructuralBiomass"), "ggplot")
  expect_s3_class(plot(G1, "FineRootBiomass"), "ggplot")
  expect_s3_class(plot(G1, "LabileBiomass"), "ggplot")
  expect_s3_class(plot(G1, "TotalBiomass"), "ggplot")
  ...
  expect_type(summary(G1, output = "LeafStructuralBiomass"), "double")
  expect_type(summary(G1, output = "SapwoodStructuralBiomass"), "double")
  expect_type(summary(G1, output = "FineRootBiomass"), "double")
  expect_type(summary(G1, output = "LabileBiomass"), "double")
  expect_type(summary(G1, output = "TotalBiomass"), "double")

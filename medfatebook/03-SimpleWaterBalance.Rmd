...
Basic water balance modelling requires the following parameters to be specified for each plant cohort. These are normally specified at the species level (see documentation for `SpParamsMED`):

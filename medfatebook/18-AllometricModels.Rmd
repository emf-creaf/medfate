...
In the case of shrubs the crown ratio is an input (species-specific) parameter ($cr$). In the case of trees, the crown ratio is modelled as a function of tree size and stand competition, following a modification of the logistic equation of @Hasenauer1996 :
\begin{equation}
...
\begin{equation}
CCF_i = \sum_{i}{N_i \cdot MCA_i}= \sum_{i}{N_i \cdot \pi \cdot (CW_i/2)^2/100}
\end{equation}

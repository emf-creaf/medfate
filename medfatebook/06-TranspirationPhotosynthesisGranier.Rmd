...
\end{equation}
where $Tr_i$ is the transpiration of plant cohort $i$, $WUE_{\max}$ is the maximum water use efficiency of the corresponding species (in $g C \cdot mm^{-1}$) and $\alpha = T_{mean}/20$ is bounded between 0 and 1.

...
Soil input requirements are the same as for the basic water balance model and are fully described in section \@ref(soilinput). In this model, however, only @Genuchten1980 water retention curves are available.

...
Crown base height ($H_{b,i}$; in $cm$) of cohort $i$ is defined as the height corresponding to the first living branch. It is calculated from the crown ratio of the cohort ($CR_i$; a proportion between 0 and 1), i.e. the ratio between crown length and total height:
\begin{equation}
...
The proportion of photosynthetic active radiation (PAR) and short-wave radiation (SWR; 400-3000 nm) decreases through the canopy following thee Beer-Lambert’s light extinction equation. 

...
#'       \itemize{
#'         \item{\code{Species}: String with species (taxon) name or a non-negative integer for herbaceous species identity (i.e., 0,1,2,...) matching SpParams.}
#'         \item{\code{Height}: Average total height of plants (in cm).}
#'         \item{\code{Cover}: Percent cover.}
#'         \item{\code{Z50}: Depth (in mm) corresponding to 50% of fine roots.}
#'         \item{\code{Z95}: Depth (in mm) corresponding to 95% of fine roots.}
...
#'         \item{\code{BelowgroundMetabolic}: Belowground metabolic carbon pool (in g C/m2)}
#'         \item{\code{SurfaceActive}: Active decomposition carbon pool in the surface (in g C/m2)}
#'         \item{\code{BelowgroundActive}: Belowground active decomposition carbon pool (in g C/m2)}
#'         \item{\code{SurfaceSlow}: Slow decomposition carbon pool in the surface (in g C/m2)}
#'         \item{\code{BelowgroundSlow}: Belowground slow decomposition carbon pool (in g C/m2)}
#'         \item{\code{BelowgroundPassive}: Belowground passive decomposition carbon pool (in g C/m2)}
#'      }
#'   }
#' }
#' @details
...
#' \code{shrubData} and \code{herbData} can contain additional columns (\code{Z100} is also commonly used for data frame \code{seedlingBank}):
#' \itemize{
...
#' 
#' Instead of defining \code{herbData}, the herbaceous layer can be defined collectively (avoiding the need to specify species parameters for herbaceous species), 
#' using the following list items:
#' \itemize{
...
#'   \item{\code{E_T1_158}}{Transpiration of Pinus halepensis cohort 'T1_158' (L/m2 of leaf area).}
#'   \item{\code{E_T2_179}}{Transpiration of Quercus ilex cohort 'T2_179' (L/m2 of leaf area).}
#'   \item{\code{FMC_T1_158}}{Fuel moisture content of Pinus halepensis cohort 'T1_158'  (in percent).}
#'   \item{\code{FMC_T2_179}}{Fuel moisture content of Quercus ilex cohort 'T2_179' (in percent).}
#'   \item{\code{BAI_T1_158}}{Basal area increment for Pinus halepensis cohort 'T1_158'  (in cm2).}
#'   \item{\code{BAI_T2_179}}{Basal area increment for Quercus ilex cohort 'T2_179' (in cm2).}
#'   \item{\code{DI_T1_158}}{Diameter increment for Pinus halepensis cohort 'T1_158'  (in cm).}
#'   \item{\code{DI_T2_179}}{Diameter increment for Quercus ilex cohort 'T2_179' (in cm).}
#'  }
#'  
#' @source

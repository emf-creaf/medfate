...
#'             \item{\code{Gs_P50 [= -5.0]}: Water potential corresponding to 50% reduction of mistletoe stomatal conductance.}
...
defaultControl<-function(transpirationMode = "Granier", 
  ...
  l <- list(
    ...
    mistletoeParams = list(kPAR = 0.5, g = 0.8, Tmax_LAI = 0.134, Tmax_LAIsq = -0.006, Gs_P50 = -5.0, Gs_slope = 30),

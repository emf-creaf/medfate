defaultControl<-function() {
  return(list(
    ...
    respirationRates = list(leaf = 0.00260274, sapwood = 6.849315e-05, fineroot = 0.002054795), # g gluc · g dw -1 · day -1
    ...
    constructionCosts = list(leaf = 1.5, sapwood = 1.47, fineroot = 1.30), #  g gluc · g dw -1

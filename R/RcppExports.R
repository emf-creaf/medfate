...
SemiImplicitTemporalIntegration <- function(WBveg, WBsoil, dt, nsmalltimesteps, opt) {
    invisible(.Call(`_medfate_SemiImplicitTemporalIntegration`, WBveg, WBsoil, dt, nsmalltimesteps, opt))
}

...
mortality_dailyProbability <- function(stressValue, stressThreshold, minValue = 0.0, slope = 1.0) {
    .Call(`_medfate_dailyMortalityProbability`, stressValue, stressThreshold, minValue, slope)
}
